  ...
  return (
    <section className="container-shell py-14">
      ...
      <div className="grid grid-cols-3 gap-3 sm:grid-cols-6">
        {POSTS.map((src, i) => (
          <div key={i} className="group relative aspect-square overflow-hidden rounded-xl bg-alabaster">
            <img src={src} alt="" className="h-full w-full object-cover transition group-hover:scale-105" />
            <div className="absolute inset-0 grid place-items-center bg-charcoal/40 opacity-0 transition group-hover:opacity-100 text-ivory">
