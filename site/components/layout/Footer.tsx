...
export default function Footer() {
  const addSubscriber = useAdminStore((s) => s.addSubscriber);
      ...
      <div className="container-shell py-14 grid sm:grid-cols-2 md:grid-cols-4 gap-8 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-ivory/80">
            <li>
              <Link href="/products?fabric=Lawn" className="link-underline">
                Luxury Lawn
              </Link>
            </li>
            <li>
              <Link href="/products?fabric=Chiffon" className="link-underline">
                Formal Chiffon
              </Link>
            </li>
            <li>
              <Link href="/products?fabric=Silk" className="link-underline">
                Raw Silk
              </Link>
            </li>
            <li>
              <Link href="/products?sale=1" className="link-underline">
                Sale
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <p className="text-ivory/70 mb-3 leading-relaxed">
            Join for new arrivals &amp; a first-order discount.
          </p>
          {subscribed ? (
            <div className="flex items-center gap-2 rounded-full border border-emerald-400/40 bg-emerald-500/10 px-4 py-2.5 text-sm text-emerald-300">
            ...
            <form
              ...
              className="flex overflow-hidden rounded-full border border-ivory/25 focus-within:border-gold"
            >
              <input
                type="email"
                required
                ...
                className="flex-1 bg-transparent px-4 py-2.5 text-ivory text-sm outline-none placeholder:text-ivory/50"
              />
              <button className="bg-gold px-5 text-sm font-semibold text-brown transition hover:bg-gold-soft">
                Join
              </button>
            </form>
          )}
