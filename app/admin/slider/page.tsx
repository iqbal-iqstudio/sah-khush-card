...
import { Plus, Pencil, Trash2, X, ArrowUp, ArrowDown, Image as ImageIcon } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm text-taupe">
            Manage the homepage hero slider. {slides.length} slide(s).
          </p>
        </div>
        <button
          onClick={openAdd}
            ...
            >
              <div className="flex gap-4 p-4">
                ...
                <div className="relative h-32 w-48 flex-shrink-0 overflow-hidden rounded-xl bg-alabaster">
                  ...
                  <span className="absolute left-2 top-2 rounded-full bg-brown/80 px-2 py-0.5 text-[10px] font-bold text-ivory">
                    #{idx + 1}
                  </span>
                </div>
                ...
                <div className="flex flex-1 flex-col justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-taupe">
                      CTA: <span className="font-medium text-charcoal">{slide.cta}</span> →{" "}
                      {slide.href}
                    </p>
                  </div>
                </div>
                  ...
                  {confirmDelete === slide.id ? (
                    <div className="flex flex-col gap-1">
                      ...
                      <button
                        ...
                        className="rounded-lg border border-taupe/30 px-2 py-1 text-[10px] font-medium text-taupe"
                      >
                        No
                      </button>
                    </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="/slide1.jpg or https://..."
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Summer Lawn, Reimagined"
                  className="w-full rounded-lg border border-taupe/30 bg-ivory px-4 py-2.5 text-sm outline-none focus:border-brown"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  rows={2}
                  value={form.copy || ""}
                  onChange={(e) => setField("copy", e.target.value)}
                  placeholder="Breathable, vibrant, perfect for Dhaka summers."
                  className="w-full rounded-lg border border-taupe/30 bg-ivory px-4 py-2.5 text-sm outline-none focus:border-brown"
                />
              </div>
